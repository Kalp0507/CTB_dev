        ...
        @endforeach
          ...
          <a href="/accidentalRepair" id='linkToAccidentalRepair' >
				...
				<div class="col-lg-2 col-md-4 col-sm-2 px-1 ServiceNames">
					...
					<div class="text-center py-4 px-3 rounded shadow serviceBlock" style="background-image: linear-gradient(#2732A3, #121A7F);">
						<img src="{{ URL::to('/') }}/images/Group 1000.png" style="width:50px;height: 50px" alt="...">
						<h6 class="textYellow pt-3 titleBlock" style="font-weight: bolder;font-size: 1rem;"> AC Servicing </h6>
					</div>
				</a>
				</div>
				<div class="col-lg-2 col-md-4 col-sm-2 px-1 ServiceNames">
...
<div>
    ...
    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 col-12 servicesParentDiv1" style="display: flex;">
        ...
        @csrf
            ...
            @else
              ...
              <input type="hidden" name="isUserEstimate" id="isUserEstimate" value="false" >
                <input type="tel" name="mobile1" class="form-control form-control-lg" pattern="[0-9]{10}" maxlength="10" id="mobile1" placeholder="Enter Mobile Number" onkeyup="nospaces(this)">
                <div class="d-none text-danger" id="requestMobileError"></div>
              </div>
            @endif
            <input type="hidden" name="serviceType" value="AC Servicing" id="serviceType">
            <input type="hidden" name="serviceId" value="4" id="serviceId">
                            ...
                            <img src="{{ URL::to('/') }}/images/addons/{{$addon->addon_icon}}" style="width:229px;height: 100% " alt="...">
                                <div class="card-content  p-4" style="width: 220px;">
                                 ...
                                 <div class="form-group px-1 pb-4 mb-0" style="/*position: absolute;bottom: 8px; width: 35%;*/">
                                     @if (Auth::check())
                                      <button type="submit" class="btn btn-block orangeButton AddonServices font-weight-bold" id="{{$addon->id}}"  data-addId="{{$addon->id}}" style="color:black;">Buy</button>
                                    @else
                                      <button type="submit" class="btn btn-block orangeButton AddNewUser font-weight-bold" id="{{$addon->id}}" data-addId="{{$addon->id}}" style="color:black;">Buy</button>
                                    @endif
                                 </div>
                                </div>
                            </div>
                ...
                <div class="modal-body">
                    ...
                    <div class="column pr-5">
                        ...
                        <div class="form-group pr-5">
                            ...
                            <div class="">
                                <select name="models" class="js-example-basic-first form-control form-control-lg modelSelect newModelSelect" id="modelSelection">
                                    @isset($modelId)
                                      <option id="model-{{$modelId}}" value="{{$modelId}}">{{$model}}</option>
                                    @endisset
                                </select>
                        ...
                        <input name="selectedService" type="hidden" class="form-control" id="selectedService" value="AC Servicing" aria-describedby="selectedServiceHelp" >
                    </div>
                </div>
