    ...
    <div class="col-lg-12 px-5 ServiceNamesBlock">
      <div class="row">
        @foreach($service as $serv)
          ...
          @elseif($serv->id == 3)
            <div class="col-lg-2 col-md-4 col-sm-2 px-1 ServiceNames">
              <a href="/mechanicalRepairServices" id="AC Servicing">
        ...
        <div class="col-lg-2 col-md-4 col-sm-2 px-1 ServiceNames">
          ...
          <div class="text-center py-4 px-3 rounded shadow serviceBlock" style="background-image: linear-gradient(#2732A3, #121A7F);">
            <img src="{{ URL::to('/') }}/images/Group 1000.png" style="width:50px;height: 50px" alt="...">
            <h6 class="textYellow pt-3 titleBlock" style="font-weight: bolder;font-size: 1rem;"> Mechanical Repair </h6>
          </div>
        </a>
        </div>
        <div class="col-lg-2 col-md-4 col-sm-2 px-1 ServiceNames">
...
<div>
  <div class="row mt-5">
    <div class="col-lg-12 px-5">
      <p style="font-weight: bolder;color: #121A7F;font-size: 1.8rem">Our Services  <i class="fas fa-angle-right mx-2" style="color:#F5E72E;"></i><span style="font-size: 1.5rem;">Mechanincal Services</span></p>
    </div>
  </div>

  <!-- <div class="row mt-3 px-5 servicesParentDiv"> -->

   <!--  <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12 servicesParentDiv1" style="display: flex;">
      ...
      <form method="post" id="acEstimateForm" action="javascript:void(0)" class="formBackground p-4">
        ...
        <div class="row shadow-lg p-4 serviceForms">
            <div class="col-lg-4 form-group mb-4">
                ...
                <!-- <select class="js-example-basic-second form-control-lg form-control" name="brands" id="brandSelect">
                  @isset($brandId))
            ...
            @else
              ...
              <input type="hidden" name="isUserEstimate" id="isUserEstimate" value="false" >
                <input type="tel" name="mobile1" class="form-control form-control-lg" maxlength="10" pattern="[0-9]{10}" id="mobile1" placeholder="Enter Mobile Number" onkeyup="nospaces(this)">
                <div class="d-none text-danger" id="requestMobileError"></div>
              </div>
            @endif
            <input type="hidden" name="serviceType" value="Mechanical Repair" id="serviceType">
            <input type="hidden" name="serviceId" value="3" id="serviceId">
          ...
          <div class="col-lg-12 RemarkBlock">
            ...
            <div class="col-lg-12 form-group partNotFoundBlock">
              ...
              <textarea name="partNotFound" id="partNotFound" class="form-control form-control-lg" style="display: none;border:1px solid #121A7F;" placeholder="Enter you query" rows="4"></textarea>
          ...
          <div class="col-lg-12" style=" align-items: center;">
            <div class="form-group m-0 col-lg-4 col-md-10 m-auto" style="padding-left: 0px;">
              <button type="submit" id="acEstimateSubmit"  class="btn btn-md btn-block home-banner-button text-light getEstimate font-weight-bold" style="padding: 10px 0px; font-size: 14px;">Submit</button>
              <button type="submit" id="acEstimateRequest"  class="btn btn-lg btn-block home-banner-button text-light getEstimateRequest font-weight-bold" style="display: none;padding: 10px 0px;font-size: 14px;">Submit</button>
            </div>
          </div>
        </div>
      </form>
                            ...
                            <img src="{{ URL::to('/') }}/images/addons/{{$addon->addon_icon}}" style="width:229px;height: 100% " alt="...">
                                <div class="card-content  p-4" style="width: 220px;">
                                 ...
                                 <div class="form-group px-1 pb-4 mb-0" style="/*position: absolute;bottom: 8px; width: 35%;*/">
                                    ...
                                    @else
                                      <button type="submit" class="btn btn-block orangeButton AddNewUser font-weight-bold" id="{{$addon->id}}" data-addId="{{$addon->id}}" style="color:blackpadding:10px 0px;">Buy</button>
                                    @endif
                                 </div>
                                </div>
                            </div>
        ...
        <div class="modal-content">
            ...
            <div class="col-lg-12 my-2">
                    ...
                    <div class="shadow px-4 pb-5">
                      ...
                      <div class="row">
                        ...
                        <div class="form-group mb-4 briefDescription col-lg-12 p-0">
                              <input type="text" class="form-control text-warning col-lg-12" placeholder="BRIEF DETAIL/DESCRIPTION">
                          </div>
                      </div>
                      <div class="row">
                        <div class="col-lg-6 p-0">
                        ...
                        <div class="form-group mb-4 briefDescription col-lg-12 p-0">
                              <input type="text" class="form-control text-warning" id="briefdescription col-lg-12" placeholder="BRIEF DETAIL/DESCRIPTION">
                          </div>
                      </div>
              ...
              <div class="modal-footer border-0">
                <h2> <a href="#" class="text-warning" style="font-weight:bolder;" data-toggle="modal" data-target="#payment"> MAKE PAYMENT </a> </h2>
              </div>
          </div>
        </div>
    </div>
            ...
            <form method="POST" action="javascript:void(0)" id="servicesForm" enctype="multipart/form-data">
                <div class="modal-body">
                    ...
                    <div class="column pr-5">
                        ...
                        <input name="selectedService" type="hidden" class="form-control" id="selectedService" value="Mechanical Repair" aria-describedby="selectedServiceHelp" >
                    </div>
                </div>
