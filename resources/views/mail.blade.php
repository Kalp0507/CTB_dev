...
<tr>
  <td>
    ...
    <table bgcolor="#ffffff" class="content" align="center" cellpadding="0" cellspacing="0" border="0">
      <tr>
        <td bgcolor="#F5E72E" class="header">
          <table width="70" align="left" border="0" cellpadding="0" cellspacing="0">  
            <tr>
              <td height="70" style="padding: 0 20px 20px 0;">
                <img class="fix" src="{{ URL::to('/') }}/images/mcm-logo.jpg"  width="70" height="70" border="0" alt="mycarmech-logo" />
              </td>
            </tr>
          </table>
          <!--[if (gte mso 9)|(IE)]>
            ...
            <tr>
              <td height="70">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td class="h1" style="padding: 5px 0 0 0;color: #2732A3">
                      MyCarMech
                    </td>
                  </tr>
                </table>
      ...
      <tr>
        <td class="footer" bgcolor="#2732A3">
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
