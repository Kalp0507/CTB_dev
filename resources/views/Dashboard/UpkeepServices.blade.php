	...
	<div class="row pt-5 pr-5">
        <div class="col-lg-12 margin-tb">
            ...
            <div class="pull-right">
                <a class="btn btn-success" href="/serviceParts/addServicePartView/6"> Add New Service</a>
            </div>
            <div class="pull-right mr-2">
                <button class="btn btn-success uploadServicesParts" id="Upkeep" data-toggle="modal" data-target="#uploadServicesCSVModal"  href="#"> Upload CSV</button>
            </div>
        </div>
    </div>
		        ...
		        @foreach ($serviceParts as $parts)
			        <tr>
			            ...
			            <td>
		                    ...
		                    <button class="btn btn-danger deleteServicePart UpkeepService" id="{{$parts->id}}" >Delete</button>
		        		</td>       
			        </tr>
		        @endforeach
	    	</tbody>
