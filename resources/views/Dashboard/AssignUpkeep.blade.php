...
<div class="row mt-5 pl-3">
    <div class="col-lg-12 margin-tb">
        ...
        <div class="pull-right">
            <a class="btn text-light blueButton" href="/Dashboard/AddNewUpkeep"> Back</a>
        </div>
    </div>
</div>
...
@endif
<form action="/AddNewUpkeep/assignUpkeep" method="POST" enctype="multipart/form-data" class="mt-3 pl-3">
    @csrf
     <div class="row" style="flex-direction: column;">
        <div class="col-xs-12 col-sm-12 col-md-6">
            <div class="form-group">
                <strong>Upkeep Name:</strong>
                <input type="text" name="upkeepName" class="form-control" placeholder="e.g. Upkeep 1" value="{{$upkeepData->package_name}}" readonly>
            </div>
        </div>
        <div class="col-xs-12 col-sm-12 col-md-6">
            <div class="form-group">
                <strong>Upkeep Description:</strong>
                <input type="text" name="upkeepDescription" class="form-control" value="{{$upkeepData->package_description}}" placeholder="e.g. Upkeep Description" readonly>
            </div>
        </div>
