	...
	<div class="row pt-5 pr-5">
        <div class="col-lg-12 margin-tb">
            ...
            <div class="pull-right">
                <a class="btn btn-success" href="/AddNewCarType/createNewCarTypeView"> Add New Car Type</a>
            </div>
	    ...
	    <table class="table table-bordered">
            ...
            <tbody>
    	        ...
    	        <tr>
    	            ...
    	            <td>
                        <a class="btn btn-primary" href="/AddNewCarType/editCarTypeView/{{$carType->id}}">Edit</a>
                        <button class="btn btn-danger deleteCarType" id="{{$carType->id}}" >Delete</button>
            		</td>       
    	        </tr>
    	        @endforeach
            </tbody>
...
<div class="modal fade" id="uploadCSVModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            ...
            <form method="POST" action="/uploadCarTypes" id="servicesForm" enctype="multipart/form-data">
                {{ csrf_field() }}
