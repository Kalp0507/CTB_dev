	...
	<div class="row pt-3 pr-5">
        <div class="col-lg-12 margin-tb">
            ...
            <div class="pull-right">
                <a class="btn btn-success" href="/serviceParts/addServicePartView/5"> Add New Battery/Tyre</a>
            </div>
            <div class="pull-right mr-2">
                <button class="btn btn-success uploadServicesParts" id="BatteryTyres" data-toggle="modal" data-target="#uploadServicesCSVModal"  href="#"> Upload CSV</button>
            </div>
        </div>
    </div>
		        ...
		        @foreach ($serviceParts as $parts)
			        <tr>
			            ...
			            <td>
		                    ...
		                    <button class="btn btn-danger deleteServicePart" id="{{$parts->id}}" >Delete</button>
		        		</td>       
			        </tr>
		        @endforeach
	    	</tbody>
