...
@section('content')
	...
	<div class="row pt-5 pr-5">
        <div class="col-lg-12 margin-tb">
            ...
            <div class="pull-right">
                <a class="btn btn-success" href="/Dashboard/insuranceCompanies/addIncCompanyView"> Add New Company</a>
            </div>
   ...
   <div class="pl-5 pr-5 pt-3">
	    <table class="table table-bordered incCompTable">
            <thead>
    	        <tr>
    	            <th>#</th>
                    <th>Company Name</th>
            ...
            <tbody>
    	        ...
    	        <tr>
    	            ...
    	            <td>
                        <a class="btn btn-primary" href="/Dashboard/insuranceCompanies/editCompanyView/{{$data->id}}">Edit</a>
                        <button class="btn btn-danger deleteCompany" id="{{$data->id}}" >Delete</button>
            		</td>       
    	        </tr>
    	        @endforeach
            </tbody>
...
<div class="modal fade" id="uploadCSVModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            ...
            <form method="POST" action="/Dashboard/uploadInsuranceCompanies" id="servicesForm" enctype="multipart/form-data">
                {{ csrf_field() }}
